...
export const Bot = (props: BotProps & { class?: string }) => {
    ...
    createEffect(async() => {
        ...
        reamAvailableQuery, IncomingInput } from '@/queries/sendMessageQuery'
import { TextInput } from './inputs/textInput'
import { GuestBubble } from './bubbles/GuestBubble'
import { BotBubble } from './bubbles/BotBubble'
...
return (
    <>
        ...
        <input type='checkbox' id='tts-toggle' checked={isTTSEnabled()} onChange={(e) => setIsTTSEnabled(e.target.checked)} />
